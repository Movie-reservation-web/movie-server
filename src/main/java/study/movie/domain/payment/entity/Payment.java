...
public class Payment extends BaseTimeEntity {
   ...
   private String buyerName;
    ...
    //==생성 메서드==//
    @Builder(builderMethodName = "impBuilder",builderClassName = "impBuilder")
    ...
    @Builder(builderMethodName = "basicBuilder",builderClassName = "basicBuilder")
    public Payment(String merchantUid, Integer amount, String buyerName, String buyerMobile, String buyerEmail) {
