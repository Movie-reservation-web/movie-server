...
import study.movie.auth.JwtTokenProvider;
...
public class LoginServiceImpl extends BasicServiceUtil implements LoginService {
    ...
    public TokenResponse login(LoginRequest request) {
        ...
        redisRepository.save(getRefreshTokenKey(authentication), tokenResponse);
    ...
    public TokenResponse reissue(TokenRequest request) {
        ...
        String key = getRefreshTokenKey(authentication);
     ...
     * @return
     */
    private String getRefreshTokenKey(Authentication authentication) {
